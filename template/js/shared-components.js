/**
 * KCOZM Salon Admin — Shared Components v5
 * ══════════════════════════════════════════
 * • Navbar = FULL WIDTH — logo lives inside navbar on the left
 * • Sidebar starts BELOW navbar (top: var(--nav-h)) — never overlaps navbar
 * • Logo always visible, always same size, unaffected by sidebar collapse
 * • Sidebar collapse only affects nav content margin
 */
(function (win) {
  'use strict';
  ...
  var CSS = `
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* ══════════════════════════════════════════
       NAVBAR — full width, logo inside on left
    ══════════════════════════════════════════ */
    .kc-navbar {
      ...
      box-shadow: 0 1px 18px rgba(24,18,12,0.07);
      z-index: 1002;
    }

    /* Logo — always visible, fixed width, inside navbar */
    .kc-nb-logo {
      display: flex; align-items: center;
      flex-shrink: 0;
    ...
    .kc-nb-logo img {
      ...
      display: block;
      filter: drop-shadow(0 1px 8px rgba(200,160,64,0.25));
    }
    ...
    .kc-sidebar {
      position: fixed;
      top: var(--nav-h);   /* ← starts BELOW navbar */
      left: 0;
      bottom: 0;
      width: var(--sb-w);
    ...
    .dark-mode .kc-navbar { background: #110d0a; border-bottom-color: rgba(200,160,64,0.15); }
